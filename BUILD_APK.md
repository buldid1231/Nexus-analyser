...
7. Unter **Artifacts** `NexusSkyrimRadar-v0.15-apk-build` herunterladen.
8. ZIP entpacken. `NexusSkyrimRadar-v0.15-debug.apk` kann direkt für einen kurzlebigen Test installiert werden.
